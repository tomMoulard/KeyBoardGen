...
example-diverse:
	...
	go run ./cmd/keyboardgen/ -input examples/diverse_test.txt -output examples/diverse_result.json -generations 30 -population 60 -mutation 0.25 -elitism 2 -verbose
